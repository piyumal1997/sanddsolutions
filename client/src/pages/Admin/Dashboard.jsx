...
const Dashboard = ({ user }) => {
  ...
  const [stats, setStats] = useState({ projects: 0, packages: 0, inquiries: 0 });
  ...
  const markAsRead = async (id) => {
    try {
      await protectedFetch(`${import.meta.env.VITE_API_BASE_URL}/api/notifications/${id}/read`, {
        method: 'PUT',
      });
      loadDashboardData();
    } catch {}
    ...
    <div className="p-6 lg:p-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
        <div className="bg-gradient-to-br from-green-50 to-green-100 p-8 rounded-2xl shadow-lg border border-green-200 hover:shadow-xl transition">
          <h3 className="text-2xl font-semibold text-green-800">Total Projects</h3>
          <p className="text-6xl font-bold text-green-700 mt-4">{stats.projects}</p>
        ...
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-8 rounded-2xl shadow-lg border border-blue-200 hover:shadow-xl transition">
          <h3 className="text-2xl font-semibold text-blue-800">Active Packages</h3>
          <p className="text-6xl font-bold text-blue-700 mt-4">{stats.packages}</p>
        ...
        <div className="bg-gradient-to-br from-red-50 to-red-100 p-8 rounded-2xl shadow-lg border border-red-200 hover:shadow-xl transition">
          <h3 className="text-2xl font-semibold text-red-800">Pending Inquiries</h3>
          <p className="text-6xl font-bold text-red-700 mt-4">{stats.inquiries}</p>
